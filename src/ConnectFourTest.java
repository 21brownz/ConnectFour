...
public class ConnectFourTest {
	 ...
	 * @throws Exception if the items can not be initialized.
	 */
	@Before
	...
	public void testP1HorizontalWinner()	{
		...
		for(int c = startPos; c < startPos+4; c++)	{
			...
			assertEquals("Correct win placement", tempPos, winningPositions[c - startPos]);
		}
		tester.newGame();
	}
	/**
	...
	public void testP1VerticalWinner()	{
		...
		for (Position winningPosition : winningPositions) {
			...
			//System.out.println("DEBUG: " + tempPos + " - " + winningPositions[i]);
			assertEquals("Correct win placement", tempPos, winningPosition);
			rowStart--;
		}
		tester.newGame();
	}
