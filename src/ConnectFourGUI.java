...
public class ConnectFourGUI extends JFrame implements ActionListener {
	...
	private JComboBox<String> p1ColorChoices;
	private JComboBox<String> p2ColorChoices;
	 ...
	 * 1) the user(s) click(s) the "new game" button, and a new game starts, provided the players have selected the proper colors for their button icons
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == newGameButton)	{
			...
			//output an error and don't allow the game to start if p1 & p2 chose identical colors
				...
				setupIcons(Objects.requireNonNull(p1ColorChoices.getSelectedItem()).toString(),
						Objects.requireNonNull(p2ColorChoices.getSelectedItem()).toString());	//establishes p1/p2 color disks plus red win disks
				game.newGame();
